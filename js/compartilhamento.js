...
class ShareManager {
    ...
    addShareButtons() {
        ...
        cards.forEach(card => {
            ...
            shareButton.addEventListener('click', (e) => {
                e.preventDefault();
                this.handleShare(card, shareButton);
            });
        });
    }

    async handleShare(card, button) {
    ...
    showShareSuccess() {
        window.notifications.success('Campanha compartilhada com sucesso!');
    }

    showShareError() {
        window.notifications.error('Erro ao compartilhar campanha');
    }
    ...
    initializeFallbackShare() {
        ...
        style.textContent = `
            .share-dialog {
                ...
                max-width: 90%;
                width: 400px;
                animation: shareDialogIn 0.3s ease;
            }
